...
import { CACHE_TTL, redisGetRaw, redisSet } from "../lib/cache.js";
import { fetchTicketLinks, fetchWorkItem, dependencyCounterpart, classifyLinkedWorkTeam } from "../services/devrevApi.js";
import { fetchAndCacheTickets, quickFetchTickets } from "../services/sync/index.js";
import { resolveDependencies } from "../services/dependencies.js";
...
export const getBatchDependencies = async (req, res) => {
  try {
    ...
    ok(res, await resolveDependencies(ticketIds));
  } catch (e) {
